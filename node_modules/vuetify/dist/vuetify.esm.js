...
const VListItemAvatar = defineComponent({
  ...
  setup(props, _ref) {
    ...
    useRender(() => createVNode(VAvatar, mergeProps({
...
const VListItemIcon = defineComponent({
  ...
  setup(props, _ref) {
    ...
    useRender(() => createVNode(VIcon, mergeProps({
    ...
    useRender(() => {
      ...
      return withDirectives(createVNode(Tag, {
        ...
        default: () => [genOverlays(isClickable || isActive.value, 'v-list-item'), hasPrepend && createVNode(Fragment, null, [props.prependAvatar && createVNode(VListItemAvatar, {
          ...
          "icon": props.prependIcon,
          "start": true
        }, null), (_slots$prepend = slots.prepend) == null ? void 0 : _slots$prepend.call(slots, slotProps.value)]), hasHeader && createVNode(VListItemHeader, {
          "key": "header"
        }, {
          default: () => [hasTitle && createVNode(VListItemTitle, {
            "key": "title"
          }, {
